...
- [ ] A preview image (GIF or PNG/JPG) is present and named correctly in `manifest.json`, is a **real capture of this animation actually running** (not a placeholder, not hand-drawn, not a screenshot of something else) — CI renders your `index.html` itself and posts a live-rendered frame next to your submitted preview so this is easy to check
